<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-dropdown align="right" width="48" class="inline-flex items-center pt-10">
                        <x-slot name="trigger">
                            <button
                                class="inline-flex items-center px-1 pt-6 text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                                <div>{{ __('Relaties') }}</div>
                                <div class="ml-1">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('client.create')"
                                             :active="request()->routeIs('client.create')">
                                {{ __('Nieuwe relatie') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('contacts.create')"
                                             :active="request()->routeIs('client.create')">
                                {{ __('Nieuw contact') }}
                            </x-dropdown-link>
                ...
                <div class="space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-dropdown align="right" width="48" class="inline-flex items-center pt-10">
                        <x-slot name="trigger" class="inline-flex items-center pt-10" >
                            <button
                                class="inline-flex items-center px-1 pt-6 text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out
                                ">
                               <div class=""> Beheer</div>
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('templates.index')"
                                             :active="request()->routeIs('templates.index')">
                                {{ __('Invoice template') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Responsive Relaties Dropdown -->
            <div x-data="{ open: false }" class="px-4">
                <button @click="open = !open"
                        class="flex items-center w-full py-2 text-sm font-medium text-gray-500 hover:text-gray-700">
            ...
            <div x-data="{ open: false }" class="px-4">
                ...
                <div x-show="open" class="pl-4 mt-2 space-y-1">
                    ...
                    <x-responsive-nav-link :href="route('invoice.create')"
                                           :active="request()->routeIs('invoice.create')">
                        {{ __('Nieuwe factuur') }}
                    </x-responsive-nav-link>
                </div>
